...
# TODO(kun): The CustomVGGNetBody() is highly customized for the other project.
#            This function has a lot of hard-coded segments. Do NOT use this function.
def CustomVGGNetBody(net, from_layer, need_fc=True, fully_conv=False, reduced=False,
        dilated=False, nopool=False, dropout=True, freeze_layers=[], dilate_pool4=False):
    kwargs = {
            'param': [dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)],
            'weight_filler': dict(type='xavier'),
